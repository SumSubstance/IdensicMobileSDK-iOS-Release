...
class ViewController: UIViewController {
    ...
    func start(fromVC: UIViewController? = nil) {
        ...
        let flowName = "msdk-basic-kyc" // the name of the applicant flow (must be set up via dashboard)
        ...
        //
        // The access token has limited lifespan and when it's expired you must provide another one.
    ...
    func setupLogging() {
        ...
        // MARK: logHandler
        //
        // By default the SDK uses `NSLog` for the logging purposes. If it does not work, you can use `logHandler` to overcome.
        //
        ...
        // It could be a good idea to shut the logs down in production
        sdk.logLevel = .off
    ...
    func setupHandlers() {
        ...
        //
        // Fired when verification process is completed with a final decision
        //
